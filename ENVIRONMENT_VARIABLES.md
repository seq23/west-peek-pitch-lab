...
| `OPENAI_API_KEY` | phase4_optional | server_secret | secret | forbidden | `DISABLED_UNLESS_PROVIDER_SELECTED` |
| `OPENAI_MODEL` | phase4_optional | server_config | plain_var | forbidden | `disabled` |
| `VOICE_PROVIDER` | phase6 | server_config | plain_var | forbidden | `elevenlabs` |
| `ELEVENLABS_API_KEY` | phase6 | server_secret | secret | forbidden | `REPLACE_WITH_LOCAL_ELEVENLABS_API_KEY` |
| `ELEVENLABS_VOICE_ID` | phase6 | server_config | plain_var | forbidden | `REPLACE_WITH_APPROVED_SCOOTER_VOICE_ID` |
| `ELEVENLABS_MODEL` | phase6 | server_config | plain_var | forbidden | `eleven_multilingual_v2` |
| `VOICE_DYNAMIC_GENERATION_ENABLED` | phase6 | server_config | plain_var | forbidden | `true` |
| `VOICE_CACHE_ENABLED` | phase6 | server_config | plain_var | forbidden | `true` |
| `VOICE_MAX_CHARS` | phase6 | server_config | plain_var | forbidden | `1200` |
| `VOICE_DAILY_MAX_RENDERS` | phase6 | server_config | plain_var | forbidden | `50` |
| `AVATAR_PROVIDER` | phase6 | server_config | plain_var | forbidden | `heygen` |
| `AVATAR_MODE` | phase6 | server_config | plain_var | forbidden | `managed_limited_video` |
| `AVATAR_DYNAMIC_GENERATION_ENABLED` | phase6 | server_config | plain_var | forbidden | `false` |
| `AVATAR_RENDER_FINAL_SUMMARY_ONLY` | phase6 | server_config | plain_var | forbidden | `true` |
| `AVATAR_MAX_SCRIPT_CHARS` | phase6 | server_config | plain_var | forbidden | `900` |
| `AVATAR_MAX_VIDEO_SECONDS` | phase6 | server_config | plain_var | forbidden | `45` |
...
| `HEYGEN_AVATAR_ID` | phase6 | server_config | plain_var | forbidden | `REPLACE_WITH_APPROVED_SCOOTER_AVATAR_ID` |
...
| `MAKEUGC_AVATAR_ID` | phase6_optional | server_config | plain_var | forbidden | `disabled` |
| `MAKEUGC_VOICE_ID` | phase6_optional | server_config | plain_var | forbidden | `disabled` |
| `SCOOTER_AVATAR_IMAGE_URL` | phase6 | public_asset | plain_var | allowed_if_public_asset | `/assets/scooter-avatar.jpg` |
| `SCOOTER_AVATAR_INTRO_VIDEO_URL` | phase6 | public_asset | plain_var | allowed_if_public_asset | `/assets/avatar/scooter-intro.mp4` |
| `SCOOTER_AVATAR_CLIP_MANIFEST` | phase6 | public_asset | plain_var | allowed_if_public_asset | `/assets/avatar/clip-manifest.json` |

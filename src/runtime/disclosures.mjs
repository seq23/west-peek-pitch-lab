...
export const DISCLOSURES = {
  ...
  privacy: 'Pitch Lab is designed to let founders practice before sharing. Founder answers stay private unless explicit Founder Story Packet share consent is given. Local camera practice stays in the browser by default.',
  noGuarantee: 'Sharing a Founder Story Packet with West Peek will not guarantee investment, investment review, review, funding, introductions, acceptance, meetings, a response, or follow-up.',

...
function renderShareForm(root, card) {
  ...
  form.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      const status = { ok: true, reviewStatus: body.review_status, contactCreated: body.contact_created === true, intakeId: body.intake_id || '', submittedAt: new Date().toISOString() };

...
function journeyMap() {
  const steps = [
    ...
    ['07', 'Add optional context', 'The founder can add anything else AI Scooter should know, especially context they chose not to upload in a confidential deck.'],
    ['08', 'Decide whether to share', 'The founder can copy and leave, keep practicing, or explicitly share the packet and selected rehearsal context with West Peek.']
  ];
  ...
  return `
    <section class="studio-shell" aria-label="Pitch Story Card review studio">
      ...
      <div class="studio-grid">
        ...
        <section class="session-card media-identity-panel" aria-labelledby="media-moments-title"><h2 id="media-moments-title">AI Scooter media identity</h2><p class="phase-note">Talking AI Scooter is core to the MVP experience and required at the welcome, final story summary, and share close moments. Text carries the detailed artifact. static/text-only mode is an honest degraded fallback, not the intended experience.</p></section>
      </div>
    </section>
  `;
}
